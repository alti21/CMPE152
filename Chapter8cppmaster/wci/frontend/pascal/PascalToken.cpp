...
void PascalToken::initialize()
{
    ...
    vector<string> rw_strings =
    {
        ...
        "UNTIL", "VAR", "WHILE", "WITH", "WHEN"//added WHEN and OTHERWISE
    };
    ...
    vector<PascalTokenType> rw_keys =
    {
        ...
        PascalTokenType::OF,
        PascalTokenType::OR,
		PascalTokenType::OTHERWISE,//added OTHERWISE
		...
		PascalTokenType::WHEN//added WHEN
    };
    ...
    vector<PascalTokenType> ss_keys =
    {
		...
		PascalTokenType::RIGHT_ARROW //added =>
