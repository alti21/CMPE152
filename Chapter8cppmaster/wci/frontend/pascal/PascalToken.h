...
enum class PascalTokenType
{
    ...
    THEN, TO, TYPE, UNTIL, VAR, WHILE, WITH, WHEN, OTHERWISE,//adding when and otherwise
...
constexpr PascalTokenType PT_WHEN = PascalTokenType::WHEN;//Adding when
constexpr PascalTokenType PT_OTHERWISE = PascalTokenType::OTHERWISE;//Adding otherwise
