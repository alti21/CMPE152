...
enum class PascalErrorCode
{
    ...
    MISSING_OF,
	MISSING_EQUALS_GREATER, //ADDED HERE
	MISSING_OTHERWISE, //ADDED HERE
    MISSING_PERIOD,
    MISSING_PROGRAM,
...
constexpr PascalErrorCode MISSING_EQUALS_GREATER = PascalErrorCode::MISSING_EQUALS_GREATER; //ADDED HERE
constexpr PascalErrorCode MISSING_OTHERWISE = PascalErrorCode::MISSING_OTHERWISE; //ADDED HERE
